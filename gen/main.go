...
import (
	...
	"github.com/khulnasoft-lab/go-plugin/encoding/tag"
	"github.com/khulnasoft-lab/go-plugin/genid"
	"github.com/khulnasoft-lab/go-plugin/version"
)
...
var (
	...
	pluginWasmPackage goImportPath = protogen.GoImportPath("github.com/khulnasoft-lab/go-plugin/wasm")
)
	...
	if strings.HasPrefix(string(m.GoIdent.GoImportPath), knownTypesPrefix) {
		m.GoIdent.GoImportPath = protogen.GoImportPath(
			strings.ReplaceAll(string(m.GoIdent.GoImportPath),
				knownTypesPrefix, "github.com/khulnasoft-lab/go-plugin/types/known/"),
		)
	}
}
